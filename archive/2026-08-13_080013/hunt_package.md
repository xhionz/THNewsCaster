...
- Generated: `2026-08-13T08:00:11+00:00`
...
## 4. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 7. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 8. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 9. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 10. Microsoft Plugs Nearly 400 Security Holes
...
## 11. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 12. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 13. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 14. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 15. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 16. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 17. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 18. #StopRansomware: Gunra Ransomware
...
## 19. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 20. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 21. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 22. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 23. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 24. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 26. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 27. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 28. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 29. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 30. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 32. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 33. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 35. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 36. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 37. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 39. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 40. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 41. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 42. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 44. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 45. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 46. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 47. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 48. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 50. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
