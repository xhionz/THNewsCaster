...
- Generated: `2026-08-13T17:39:47+00:00`
...
## 1. Critical VMware vCenter RCE flaw exploited for reverse SSH access
...
## 5. Lazarus hackers exploited Windows zero-day to target defense firms
...
## 6. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 7. Adobe Patches Three CVSS 10.0 ColdFusion and Campaign Classic Flaws
...
## 8. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 9. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 10. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 13. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 14. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 15. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 16. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 17. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 18. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 19. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 20. #StopRansomware: Gunra Ransomware
...
## 21. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 22. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 23. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 24. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 25. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 26. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 28. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 29. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 30. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 31. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 32. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 34. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 35. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 37. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 38. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 39. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 41. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 42. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 43. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 44. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 46. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 47. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 48. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 49. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 50. VMware fixes three critical flaws allowing auth bypass, VM escapes
