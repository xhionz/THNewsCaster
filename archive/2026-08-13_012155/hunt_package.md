...
- Generated: `2026-08-13T01:21:52+00:00`
...
## 2. Lazarus hackers exploited Windows zero-day to target defense firms
...
## 3. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 4. Adobe Patches Three CVSS 10.0 ColdFusion and Campaign Classic Flaws
...
## 5. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 6. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 10. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 11. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 12. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 13. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 14. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 15. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 16. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 17. #StopRansomware: Gunra Ransomware
...
## 18. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 19. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 20. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 21. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 22. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 23. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 25. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 26. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 27. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 28. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 29. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 31. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 32. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 34. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 35. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 36. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 38. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 39. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 40. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 41. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 43. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 44. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 45. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 46. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 47. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 49. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 50. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
