...
- Generated: `2026-08-13T18:21:32+00:00`
...
## 2. Critical VMware vCenter RCE flaw exploited for reverse SSH access
...
## 3. Nightmare Eclipse Drops Windows Zero-Day Exploit ‘ShieldBreak’
...
## 4. Attackers Exploit SharePoint Authentication Bypass After Public PoC Release
...
## 6. Lazarus hackers exploited Windows zero-day to target defense firms
...
## 7. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 8. Adobe Patches Three CVSS 10.0 ColdFusion and Campaign Classic Flaws
...
## 9. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 10. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 11. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 12. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 13. Microsoft Plugs Nearly 400 Security Holes
...
## 15. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 16. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 17. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 18. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 19. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 20. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 21. #StopRansomware: Gunra Ransomware
...
## 22. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 23. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 24. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 25. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 26. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 27. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 29. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 30. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 31. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 32. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 33. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 35. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 36. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 38. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 39. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 40. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 42. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 43. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 44. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 45. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 47. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 48. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 49. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 50. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
