...
- Generated: `2026-08-12T09:42:18+00:00`
...
## 2. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 5. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 6. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 7. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 8. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 9. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 10. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 11. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 12. #StopRansomware: Gunra Ransomware
...
## 13. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 14. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 15. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 16. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 17. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 18. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 20. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 21. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 23. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 24. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 26. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 27. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 29. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 30. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 31. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 33. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 34. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 35. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 36. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 38. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 39. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 40. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 41. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 42. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 44. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 45. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 46. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 47. Russian Hackers Exploit Microsoft OWA Flaw to Keep Mailbox Access After Credential Rotation
...
## 48. Flying Eagle Android RAT: Leaked Source Code, 170 Servers, and a Successor Called Night Dragon
...
## 49. Cisco Secure FMC Zero-Day Exploited in the Wild
...
## 50. Russian hackers exploit Exchange OWA zero-day for long-term mailbox access
