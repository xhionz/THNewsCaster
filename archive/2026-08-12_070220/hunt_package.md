...
- Generated: `2026-08-12T07:02:17+00:00`
...
## 2. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 4. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 5. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 6. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 7. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 8. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 9. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 10. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 11. #StopRansomware: Gunra Ransomware
...
## 12. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 13. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 14. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 15. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 16. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 17. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 19. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 20. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 21. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 22. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 23. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 25. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 26. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 28. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 29. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 30. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 32. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 33. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 34. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 35. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 37. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 39. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 40. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 41. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 43. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 44. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 45. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 47. Flying Eagle Android RAT: Leaked Source Code, 170 Servers, and a Successor Called Night Dragon
...
## 48. Cisco Secure FMC Zero-Day Exploited in the Wild
...
## 49. Russian hackers exploit Exchange OWA zero-day for long-term mailbox access
...
## 50. Cisco warns of FMC static credential flaw exploited in zero-day attacks
