...
- Generated: `2026-08-13T11:11:11+00:00`
...
## 1. Nightmare Eclipse Drops Windows Zero-Day Exploit ‘ShieldBreak’
...
## 4. Lazarus hackers exploited Windows zero-day to target defense firms
...
## 5. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 6. Adobe Patches Three CVSS 10.0 ColdFusion and Campaign Classic Flaws
...
## 7. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 8. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 9. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 10. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 11. Microsoft Plugs Nearly 400 Security Holes
...
## 12. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 13. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 14. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 15. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 16. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 17. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 18. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 19. #StopRansomware: Gunra Ransomware
...
## 20. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 21. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 22. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 23. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 24. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 25. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 27. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 28. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 29. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 30. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 31. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 33. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 34. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 36. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 37. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 38. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 40. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 41. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 42. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 43. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 45. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 46. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 47. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 48. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 49. VMware fixes three critical flaws allowing auth bypass, VM escapes
