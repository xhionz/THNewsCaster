...
- Generated: `2026-08-12T15:25:36+00:00`
...
## 1. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 3. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 4. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 5. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 6. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 9. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 10. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 11. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 12. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 13. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 14. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 15. #StopRansomware: Gunra Ransomware
...
## 16. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 17. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 19. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 20. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 21. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 23. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 24. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 25. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 26. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 27. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 29. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 30. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 32. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 34. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 36. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 37. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 38. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 39. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 41. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 42. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 43. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 44. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 45. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 47. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 48. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 49. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 50. Russian Hackers Exploit Microsoft OWA Flaw to Keep Mailbox Access After Credential Rotation
