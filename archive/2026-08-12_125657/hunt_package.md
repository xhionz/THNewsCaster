...
- Generated: `2026-08-12T12:56:54+00:00`
...
## 1. Adobe Patches Three CVSS 10.0 ColdFusion and Campaign Classic Flaws
...
## 2. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 3. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 4. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 5. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 7. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 8. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 9. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 10. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 11. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 12. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 13. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 14. #StopRansomware: Gunra Ransomware
...
## 16. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 17. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 18. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 19. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 20. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 22. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 23. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 24. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 26. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 28. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 29. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 31. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 32. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 33. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 35. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 36. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 37. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 38. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 40. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 41. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 42. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 43. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 44. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 46. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 47. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 48. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 49. Russian Hackers Exploit Microsoft OWA Flaw to Keep Mailbox Access After Credential Rotation
...
## 50. Flying Eagle Android RAT: Leaked Source Code, 170 Servers, and a Successor Called Night Dragon
