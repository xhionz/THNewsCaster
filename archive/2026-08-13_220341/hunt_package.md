...
- Generated: `2026-08-13T22:03:38+00:00`
...
## 1. Global Threat Campaign Hits Critical VMware vCenter Flaw
...
## 4. Nightmare Eclipse Drops Windows Zero-Day Exploit ‘ShieldBreak’
...
## 6. Lazarus Exploits Windows Zero-Day to Gain SYSTEM Access and Deploy Backdoor
...
## 7. Lazarus hackers exploited Windows zero-day to target defense firms
...
## 8. Zoomsday: Zero-click RCE in Zoom, from any meeting participant to any other (CVE-2026-53413)
...
## 9. Adobe Patches Three CVSS 10.0 ColdFusion and Campaign Classic Flaws
...
## 10. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 11. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 12. Cisco Patches Firewall Zero-Day Exploited for DoS Attacks
...
## 13. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 14. Microsoft Plugs Nearly 400 Security Holes
...
## 15. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 16. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 17. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 18. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 19. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 20. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 21. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 22. #StopRansomware: Gunra Ransomware
...
## 23. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 24. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 25. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 26. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 27. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 28. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 30. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 31. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 32. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 33. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 34. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 36. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 37. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 39. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 40. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 41. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 43. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 44. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 45. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 46. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 49. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 50. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
