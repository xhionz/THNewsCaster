...
- Generated: `2026-08-12T11:37:09+00:00`
...
## 1. New Microsoft Defender 'ShieldBreak' zero-day grants SYSTEM privileges
...
## 2. Cisco ASA and FTD Flaw Exploited in the Wild Can Trigger Remote DoS
...
## 4. Microsoft Patch Tuesday for August 2026 — Snort rules and prominent vulnerabilities
...
## 6. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 8. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 9. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 10. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 11. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 12. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 13. #StopRansomware: Gunra Ransomware
...
## 14. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 15. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 16. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 17. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 18. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 19. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 21. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 22. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 23. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 24. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 25. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 27. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 28. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 30. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 31. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 32. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 34. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 35. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 36. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 37. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 39. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 40. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 41. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 42. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 43. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 45. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 46. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 47. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 48. Russian Hackers Exploit Microsoft OWA Flaw to Keep Mailbox Access After Credential Rotation
...
## 49. Flying Eagle Android RAT: Leaked Source Code, 170 Servers, and a Successor Called Night Dragon
...
## 50. Cisco Secure FMC Zero-Day Exploited in the Wild
