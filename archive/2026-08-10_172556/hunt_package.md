...
- Generated: `2026-08-10T17:25:52+00:00`
...
## 1. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 2. #StopRansomware: Gunra Ransomware
...
## 4. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 5. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 6. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 8. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 10. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 11. New WordPress Pre-Auth XSS Could Lead to PHP Code Execution - Patch ASAP
...
## 12. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 13. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 14. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 16. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 17. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 20. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 21. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 24. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 25. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 26. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 28. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 29. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 30. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 31. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 32. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 34. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 35. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 36. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 37. Russian Hackers Exploit Microsoft OWA Flaw to Keep Mailbox Access After Credential Rotation
...
## 38. Flying Eagle Android RAT: Leaked Source Code, 170 Servers, and a Successor Called Night Dragon
...
## 39. Cisco Secure FMC Zero-Day Exploited in the Wild
...
## 40. Russian hackers exploit Exchange OWA zero-day for long-term mailbox access
...
## 41. Cisco warns of FMC static credential flaw exploited in zero-day attacks
...
## 43. Critical Rails Flaw Could Let Unauthenticated Attackers Read Server Files via Image Uploads
...
## 44. CVE-2026-63077: Critical unauthenticated remote code execution in JetBrains TeamCity
...
## 45. Three Critical VMware Flaws Allow Auth Bypass, Code Execution, and VM Escape
...
## 46. Researchers Show a Single Malicious Webpage Visit Can Compromise Tor Browser
...
## 47. Public PoC Released for Exploited Check Point SmartConsole Authentication Bypass
...
## 48. Check Point SmartConsole Authentication Bypass Technical Analysis (CVE-2026-16232)
...
## 49. vBulletin fixes critical pre-auth RCE flaw with public exploit
...
## 50. Siemens SIMATIC S7-1500 CPU 1518(F)-4 PN/DP MFP
