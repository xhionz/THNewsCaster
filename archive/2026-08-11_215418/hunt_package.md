...
- Generated: `2026-08-11T21:54:15+00:00`
- Generator: `THNewsCaster v0.1.0`
- Articles seen: **295**  ·  Skipped (below threshold): **292**  ·  Briefings: **50**
...
## 2. Microsoft Patches 398 Flaws Including a Windows Driver Zero-Day Under Active Attack
...
## 3. August 2026 Patch Tuesday: Microsoft Fixes 421 CVEs, One Exploited Zero-Day
...
## 4. CVE-2026-63520: Microsoft SharePoint Remote Code Execution (FIXED)
...
## 5. CISA: Microsoft SharePoint flaw now exploited in ransomware attacks
...
## 6. Gunra Ransomware Exploits Fortinet and Schneider Electric Flaws to Breach Networks
...
## 7. China-Linked Hackers Deploy New StormEncryptor Ransomware, Likely via N-central Flaw
...
## 8. Coruna, DarkSword iOS Exploits Proliferate Globally
...
## 9. #StopRansomware: Gunra Ransomware
...
## 10. CISA: SonicWall SMA1000 flaws now exploited by ransomware gangs
...
## 11. Critical Progress LoadMaster flaw now actively exploited in attacks
...
## 12. CISA Urges Immediate Patching of Exploited Progress LoadMaster Vulnerability
...
## 13. SolarWinds SUNBURST — what the logs actually showed (DNS analysis, Splunk queries, 5 detection gaps)
...
## 14. Metabase Zero-Day Exploited in Wild Allows Admin Access Without Authentication
...
## 15. Metabase SQLi zero-day exploited in customer data-theft attacks
...
## 17. Rapid7 Analysis: Unauthenticated Remote Code Execution in JetBrains TeamCity (CVE-2026-63077)
...
## 19. 18-Year-Old Linux SCTP Flaw Could Let Local Users Gain Root and Escape Containers
...
## 20. Microsoft 365 AitM Phishing Hijacks Accounts to Collect Payroll and Finance Emails
...
## 21. New TONTOU CPU attack bypasses Spectre v2 fixes, leaks Linux password hashes
...
## 23. CISA Flags TeamCity CVE-2026-63077 RCE Flaw Under Active Exploitation in the Wild
...
## 24. Hackers Start Exploiting Recent JetBrains TeamCity Vulnerability
...
## 26. Veeam, Terraform MCP, Django Patch Critical Flaws, Led by CVSS 10.0 Cross-Tenant Bug
...
## 27. Critical Gitea Flaw Let Unauthenticated Attackers Read Server Files via Org-Mode Markup
...
## 28. CISA Flags Langflow RCE, Tomcat, and N-central Flaws as Actively Exploited
...
## 30. Keyv-Linked npm Worm Poisons Hundreds of Packages, Plants Claude Code and VS Code Hooks
...
## 31. CVE-2026-18577: N-able N-central Authentication Bypass Exploited in the Wild
...
## 32. CISA Adds Exploited N-able N-central Flaw to KEV After Customer Compromises
...
## 33. Attackers Exploit N-able Patch Bypass Flaw on RMM Servers
...
## 35. INC Ransomware Emerges as Dominant Actor Exploiting SonicWall SMA 1000 Flaws
...
## 36. N-able Says Attackers Take Over N-central Servers After Initial Fix Proves Incomplete
...
## 37. Adobe Campaign Classic CVSS 10.0 Flaw Could Run Code Without User Interaction
...
## 38. CaptiveCrunch: Midnight Blizzard targets travelers worldwide for malware delivery and credential theft
...
## 39. VMware fixes three critical flaws allowing auth bypass, VM escapes
...
## 41. KindaRails2Shell: CVE-2026-66066, Critical Arbitrary File Read and Possible Remote Code Execution in Ruby on Rails
...
## 42. Azure Cosmos DB Flaw Exposed Platform-Wide Key That Could Access Any Database
...
## 43. Critical VMware vCenter Vulnerabilities Allow Authentication Bypass and Remote Code Execution (CVE-2026-59309, CVE-2026-59310)
...
## 44. Russian Hackers Exploit Microsoft OWA Flaw to Keep Mailbox Access After Credential Rotation
...
## 45. Flying Eagle Android RAT: Leaked Source Code, 170 Servers, and a Successor Called Night Dragon
...
## 46. Cisco Secure FMC Zero-Day Exploited in the Wild
...
## 47. Russian hackers exploit Exchange OWA zero-day for long-term mailbox access
...
## 48. Cisco warns of FMC static credential flaw exploited in zero-day attacks
...
## 50. Critical Rails Flaw Could Let Unauthenticated Attackers Read Server Files via Image Uploads
